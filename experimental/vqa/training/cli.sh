...
export DISPLAY_NAME="vqa_training_job_$UUID"
export MACHINE_TYPE="n1-standard-4"
export REPLICA_COUNT=1
export EXECUTOR_IMAGE_URI="us-docker.pkg.dev/vertex-ai/training/tf-gpu.2-12.py310:latest"
export PYTHON_PACKAGE_URI=$GCS_BUCKET_URI/vqa-app-trainer.tar.gz
export PYTHON_MODULE="trainer.task"
export ACCELERATOR_TYPE="NVIDIA_TESLA_T4"
export ACCELERATOR_COUNT=1 #1
export GCP_REGION="us-central1" # Adjust region based on you approved quotas for GPUs

#we can try in the meantime we can use CPU 
export CMDARGS="--epochs=2,--batch_size=16,--wandb_key=85748c0c686547e3b0ecb79b744ed8270804092e"
