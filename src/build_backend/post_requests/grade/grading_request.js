function getExtractedTextAndSendGradingRequest() {
  ...
  fetch('https://extract-text-jsrdxhl2pa-ue.a.run.app/extract-text')
    ...
    .then(data => {
      ...
      const gradingUrl = "https://bitesize-grading-jsrdxhl2pa-ue.a.run.app/generate-explanations";
    ...
    .then(data => {
      ...
      const bucketUrl = "https://bitesize-grading-jsrdxhl2pa-ue.a.run.app/empty-bucket";
